...
const BlogTitles = () => {
  ...
  const blogCategories = ['General','Technology','Business','health','Lifestyle','Eduction','Travel','Food'];
    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        rounded-md border border-gray-300"
          required
        />
        <p className="mt-6 text-sm front-medium">Category</p>
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-96">
        <div className="flex item-center gap-3">
          ...
          <h1 className="text-xl font-semibold text-[#8E37EB]">Generate titles</h1>
        </div>
