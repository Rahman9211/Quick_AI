...
const Sidebar = ({ sidebar, setSidebar }) => {
  ...
  return (
    <div
      className={`w-63 bg-white border-r border-gray-200 flex
    ...
    >
      <div className="my-7 w-full">
        ...
        <div className="mt-5 px-6 text-sm text-gray-600 front-medium">
      ...
      <div className="w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between">
        <div
          ...
          className="flex gap-2 items-cnter cursor-pointer"
        >
